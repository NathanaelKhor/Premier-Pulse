...
public class PlayerService {
    ...
    public List<Player> getPlayersByTeamAndPosition(String team, String position){
        return playerRepository.findAll().stream().filter(player -> team.toLowerCase().equals(player.getTeam().toLowerCase()) && position.toLowerCase().equals(player.getPos().toLowerCase())).collect(Collectors.toList());
    }
